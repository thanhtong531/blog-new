...
export default function PostItem({ post, handleDelete, handleEdit }: PostItemType) {
  ...
  return (
    <div className='flex flex-col items-center overflow-hidden rounded-lg border md:flex-row post-item'>
      ...
      <div className='flex flex-col gap-2 p-4 lg:p-6'>
        ...
        <div>
          <div className='inline-flex rounded-md shadow-sm' role='group'>
            ...
            <button
              type='button'
              className='rounded-r-lg border-t border-b border-r border-gray-200 bg-white py-2 px-4 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:text-blue-700 focus:ring-2 focus:ring-blue-700 button-del'
